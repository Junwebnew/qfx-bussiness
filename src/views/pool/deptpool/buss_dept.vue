    ...
    <div class="app-container">
        ...
        <div class="back-fff pad20">
            ...
            <el-table v-loading="loading" :data="tableData" row-key="id">
                ...
                <el-table-column label="商机状态" prop="followStatusName" width='100'></el-table-column>
                <!-- <el-table-column label="资源来源"  prop="resourceId" show-overflow-tooltip></el-table-column> -->
                <el-table-column label="资源类型" prop="resName" width='100'></el-table-column>
                <el-table-column label="业务类型" prop="vocName" width='100'></el-table-column>
...
<script>
import { bussDeptPool, bussDeptReceive } from "@/api/center";
...
export default {
    ...
    methods: {
        ...
        getList() {   //获取table表单的数据**************************************
            ...
            bussDeptPool(this.queryParams).then(response => {
        ...
        handleDistribution(obj) {
            ...
            this.$confirm('是否领取 ' + obj.customerName + ' 此条资源?', "警告", {
                ...
                return bussDeptReceive({ id: obj.id });
