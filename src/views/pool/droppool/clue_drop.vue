    ...
    <div class="app-container">
        ...
        <div class="back-fff pad20">
            ...
            <el-table v-loading="loading" :data="tableData" row-key="id">
                ...
                <el-table-column label="联系方式" prop='contactPhone' width='130' :formatter='formatterPhone'> </el-table-column>
                ...
                <el-table-column label="掉库时间" width='160' prop="createTime" show-overflow-tooltip></el-table-column>
    ...
    methods: {
        ...
        handleDistribution(obj) {
            ...
            this.$confirm('是否领取 ' + obj.customerName + ' 此条资源?', "警告", {
                ...
                return publicPoolReceive({ ids: [obj.id], type: 1 });
