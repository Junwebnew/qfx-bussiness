export const Constellationel = (childEle, fatherEle) => {
    var timer;
    var canvas = document.getElementById(childEle);

    var ctx = canvas.getContext("2d");
    var father = document.getElementById(fatherEle)
    resize();
