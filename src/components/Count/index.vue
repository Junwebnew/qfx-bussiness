...
export default {
    ...
    methods: {
        ...
        VailVal(key) {
            ...
            this[key] = numStr.length > 7 ? '99999999' : numStr;
        }
    }
};
</script>
...
.count {
    ...
    &.active {
        ...
        -webkit-box-shadow: inset 1px 1px 3px 1px #e0f3ff,
            inset -1px -1px 3px 1px #e0f3ff;
        box-shadow: inset 1px 1px 3px 1px #e0f3ff,
            inset -1px -1px 3px 1px #e0f3ff;
    }
    > div {
        height: 100%;
